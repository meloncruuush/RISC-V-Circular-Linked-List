...
DECODING:
    ...
    check_del:
        lb t1 0(a1)
        li t2 68
        bne t1 t2 check_SORT              # controllo se è D, altrimenti passo alla prossima, MISSING
    ...
    check_sort:
        lb t1 0(a1)
        li t2 83
        bne t1 t2 check_rev              # controllo se è S, altrimenti passo alla prossima, rev
        
        addi a1 a1 1
        lb t1 0(a1)
        li t2 79
        bne t1 t2 check_next_instruction # controllo se è O, se no, è formattata male, prossima istruzione
